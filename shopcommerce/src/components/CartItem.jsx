        ...
        <div className="w-full flex flex-col ">
          ...
          <div className=" flex gap-x-2 h-[36px] text-sm">
            <div className="flex flex-1 max-w-[100px]  items-center h-full border text-gray-700 font-medium">
              ...
              <div className="flex-1 h-fulll flex justify-center items-center cursor-pointer " onClick={()=>increaseAmount(id)}>
                <IoMdAdd   />
              </div>
            </div>
            <div className="flex-1 flex items-center justify-around   ">$ {price}</div>
            <div className="flex-1 flex  font-medium justify-end items-center text-gray-700">{`$ ${parseFloat(price * amount).toFixed(2)}`}</div>
          </div>
        </div>
      </div>
    </div>
